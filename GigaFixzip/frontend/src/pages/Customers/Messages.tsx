  ...
  return (
    <div>
      <div className="mb-4 sm:mb-6">
        ...
        <p className="text-slate-600 text-sm sm:text-base">Communicate with service professionals</p>
      </div>
                ...
                <div className="p-3 sm:p-4 border-t border-slate-200">
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="w-10 h-10 bg-green-600 text-white rounded-xl flex items-center justify-center hover:bg-green-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0"
                    >
